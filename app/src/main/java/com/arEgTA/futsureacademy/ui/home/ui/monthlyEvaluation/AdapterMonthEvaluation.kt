...
RecyclerView.Adapter<AdapterMonthEvaluation.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val viwe: View =
            LayoutInflater.from(parent.context).inflate(R.layout.item_month_evaluation, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        val sharedPreferences = holder.contentMonth.context.getSharedPreferences("sharedPrefFile", Context.MODE_PRIVATE)
