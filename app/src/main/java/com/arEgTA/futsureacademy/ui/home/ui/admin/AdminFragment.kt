...
class AdminFragment : BaseFragmentHome<FragmentAllStudentBinding>(FragmentAllStudentBinding::inflate){
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapterAdmin = AdapterAdmin(ArrayList(),{
            ...
            editor.apply()
            editor.commit()
            Toast.makeText(activity,"${activity?.getString(R.string.opend)}${it.name}",Toast.LENGTH_LONG).show()
        })
        // delete user
        {
