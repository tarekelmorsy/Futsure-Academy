...
class SeasonDetailsFragment :
    BaseFragmentHome<FragmentSeasoneDetailsBinding>(FragmentSeasoneDetailsBinding::inflate) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btUpdateSeason.setOnClickListener {
            findNavController().navigate(
                SeasonDetailsFragmentDirections.actionSeasoneDetailsFragmentToUpdateSeasonFragment(
                    season
                )
            )
